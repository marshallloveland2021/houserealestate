...
import { defaultPosts } from './post-data'; // ✅ make sure this matches the export name
...
export class DataService {
  ...
  constructor() {
    ...
    this.posts = Array.isArray(parsed) && parsed.length
      ? parsed
      : defaultPosts;
...
addPost(post: Post) {
  post.verified = false; // force unverified on creation
